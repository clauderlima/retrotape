...
constexpr char AudioTest[] = "Audio test";
constexpr char AudioDiagnostics[] = "Output diagnostics";
constexpr char TestTone[] = "Test tone";
constexpr char OutputLevel[] = "Output level";
constexpr char FiveSeconds[] = "Each tone plays for 5 seconds";
constexpr char ToneReady[] = "Select a test frequency";
constexpr char ToneFinished[] = "Test tone finished";
